...
public class Week06 {
	...
	public static final String STR = "";
	...
	public static void main(String[] args) {
		...
		//		System.out.println("challenge04 ascii[" + strHexadecimalToAscii(STR) + "]");
		
	}
	
	
//	public static final String N_03 = "323";
	public static final String N_03 = 
	...
	public static final BigInteger challenge03() {
		
		BigInteger n = new BigInteger(N_03);
		BigInteger q = sqrt(n.multiply(BigInteger.valueOf(6)));
		BigInteger p = n.subtract(q);
		
		
		
//		d = d.multiply(d);
//		d = d.divide(BigInteger.valueOf(24));
//		System.out.println(d);
//		
		
		
//		BigInteger c = sqrt(sqrt(n));
//		System.out.println("c: " + c);
//		c = c.subtract(c.add(c));
//		System.out.println("c: " + c);
//		BigInteger d = sqrt(n.multiply(BigInteger.valueOf(24)));
//		System.out.println("d: " + d);
//		BigInteger q = d.subtract(c).divide(BigInteger.valueOf(4));
//		BigInteger p = n.subtract(q);
	...
	public static final String challenge04() {
		...
		BigInteger p = Week06.challenge01();
	...
	public static String strHexadecimalToAscii(String input) {
		...
		for(int i=0; i<input.length(); i=i+2) {
			...
			Character ch = new Character((char)Integer.parseInt(subStrEncription, 10));
			output += ch.toString();
		}		
		return output;
	}
