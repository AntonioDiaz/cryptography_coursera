...
public class Question01 {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException,
		...
		SecretKeySpec secretKeySpecy = new SecretKeySpec(key.getBytes(), aesEncryptionAlgorithm);
		
		
		Cipher encryptCipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
		
		 encryptCipher.init(Cipher.DECRYPT_MODE, secretKeySpecy);    
		...
		decryptCipher.init(Cipher.DECRYPT_MODE, secretKeySpecy, ivParameterSpec);
